package org.steamzone.shaked.rest.error;
...
public class RetrofitException extends RuntimeException {
    ...
    public enum Kind {
        ...
        NETWORK,
        /** A non-200 HTTP status communityItem was received from the server. */
        HTTP,
        /**
    ...
    /** Response object containing status communityItem, headers, body, etc. */
